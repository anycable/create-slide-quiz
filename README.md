...
1. Creating an [AnyCable Plus](https://plus.anycable.io) app (free tier, up to 2,000 connections)
2. Scaffolding a new project or adding quizzes to an existing Reveal.js or Slidev deck
